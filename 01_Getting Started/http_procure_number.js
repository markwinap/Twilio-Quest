...
{ available_phone_numbers:
   [ { friendly_name: '(510) 480-3954',
       phone_number: '+15104803954',
       lata: '722',
       rate_center: 'ELSBR-PINL',
       latitude: null,
       longitude: null,
       locality: 'El Sobrante Pinole',
       region: 'CA',
       postal_code: null,
       iso_country: 'US',
       ...
       capabilities: [Object] } ],
  uri:
   '/2010-04-01/Accounts/AC31dc21046160bf3d675ef09e6bc5ce19/AvailablePhoneNumbers/US/Local.json?AreaCode=510&PageSize=1' }
...
async function main(){
      let params = {
            method: 'GET', //POST
            path: `/AvailablePhoneNumbers/US/Local.json?${querystring.stringify({ AreaCode: 510, PageSize: 1})}`,//AreaCode=510&PageSize=1
      ...
      if(numbers){
            let params = {
                ...
                data: querystring.stringify({ PhoneNumber: numbers.available_phone_numbers[0].phone_number})//PhoneNumber=+15103808519
            }
